...
public class SIxImpl implements Six {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(six.mean("Beijing",data));
        System.out.println(six.mean("London",data));

        for (int i = 0; i < towns.length; i++) {
            double avg=six.mean(towns[i],data);
            if (avg!=-1||!towns[i].equals("Beijing")) sum+=avg;
...
//        for (int i = 0; i < towns.length; i++){
//            double avg = six.mean(towns[i], data);
//            sumMinus += Math.pow(avg - avgSum, 2);
//        }
//        System.out.println(Math.sqrt(sumMinus/10));
